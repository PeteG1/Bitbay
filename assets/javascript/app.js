...
// Submit the request
    ...
    //Results Container jQuery
        ...
        $("#result-1").append("<p>" + '<img src="' + onePic + '" border="0" width="125" height="125">' + "</p>");
        $("#result-2").append("<p>" + '<img src="' + twoPic + '" border="0" width="125" height="125">' + "</p>");
        $("#result-3").append("<p>" + '<img src="' + threePic + '" border="0" width="125" height="125">' + "</p>");
